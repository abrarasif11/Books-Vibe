    ...
    <div className="hero bg-[#F3F3F3] mx-auto mt-10 mb-10">
      <div className="hero-content flex-col lg:flex-row">
        ...
        <div className="ml-10">
          ...
          <button onClick={()=> handleMarkAsRead(bookId)} className="btn btn-outline mr-10 p-3 rounded-lg">Mark As Read</button>
          <button className="btn bg-[#50B1C9] text-white rounded-lg">Add to Wishlist</button>
          </div>
        </div>
      </div>
    </div>
